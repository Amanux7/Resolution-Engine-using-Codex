...
export interface Evidence { id:string; caseId:string; filename:string; mimeType:string; size:number; storageKey:string; storageUrl?:string; sourceType:EvidenceSourceType; processingStatus:EvidenceProcessingStatus; extractedFactsCount:number; uploadedAt:string; createdAt:string; updatedAt:string; sizeLabel?:string; errorMessage?:string; }
